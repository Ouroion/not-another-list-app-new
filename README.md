...
```
cd existing_repo
git remote add origin https://gitlab.com/c3334/not-another-list-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/c3334/not-another-list-app/-/settings/integrations)
